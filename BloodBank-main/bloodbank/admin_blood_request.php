                        ...
                        while ($row = mysqli_fetch_assoc($result)){
                            ...
                            echo "<tr>";
                                ...
                                if ($row['status'] == 'pending')
                                {
                                    ...
                                    <input type = 'submit' name = 'approve' value = 'Approve' class='btn btn-success ' style='width:180px;height:60px;'><br><br> ";
                                    echo "<input type = 'submit' name = 'reject' value = 'Reject' class='btn btn-danger '  style='width:180px;height:60px;'>";
                                    echo "<input type = 'hidden' name = 'request_id' value = " . $row['request_id'] ." >";
                                    echo "<input type = 'hidden' name = 'requester_id' value = " . $row['requestor_id'] ." >";
