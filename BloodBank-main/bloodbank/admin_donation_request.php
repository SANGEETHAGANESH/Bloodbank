                ...
                <?php
                    ...
                    while ($row = mysqli_fetch_assoc($result)){
                        ...
                        echo "<tr>";
                            ...
                            {
                                if($row['usertype']=='Emergency user'){
                                    echo "<td align='center'><form method = 'POST' action='send.php'>
                                    <input type = 'submit' name = 'send' value = 'Send Mail' class='btn btn-success' style='width:180px;height:60px;''> <br><br>";
                                    ...
                                    <input type = 'submit' name = 'approve' value = 'Approve' class='btn btn-primary' style='width:180px;height:60px;''> <br><br>";
                                    echo "<input type = 'submit' name = 'reject' value = 'Reject' class='btn btn-danger ' style='width:180px;height:60px;' >";
                                    echo "<input type = 'hidden' name = 'donation_id' value = " . $row['donation_id'] ." >";
                                    echo "<input type = 'hidden' name = 'donor_id' value = " . $row['donor_id'] ." >";
                                    echo "<input type = 'hidden'  name = 'unit' value = " . $row['unit'] ."></form></td>";
                                }
