...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top bg-danger">
        <a style="color:white;" class="navbar-brand" href="request_blood.php">Blood Bank Management </a>
            ...
            <div class="wrapper wrapper--w790">
              ...
              { 
                 ...
                 if($_SERVER["REQUEST_METHOD"] == "POST") {
                  ...
                  if($row['unit'] > $unit) {
                      $sql="INSERT INTO blood_request VALUES('$unit','$reason','$location','$bloodtype','$request_date','$requestor_id','$request_id','$admin_id','$status','$action')";
                      ...
                      $sql = "INSERT INTO blood_request VALUE('$unit','$reason','$location','$bloodtype','$request_date','$requestor_id','$request_id','$admin_id','$status','$action')";

                      if($con->query($sql) == TRUE){
                          echo "Please wait we will click and update the status ";
                      }
                      else{
                          echo "Error: " . $sql . "<br>" . $con->error;
                      }
