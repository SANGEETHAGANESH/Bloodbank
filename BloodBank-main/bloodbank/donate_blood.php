...
<div class="wrapper">
    ...
    <div class="main_content">
        <div class="page-wrapper bg-gra-03 mt-4 p-b-50">
                        ...
                        <div align = 'center'>
                            ...
                            #for inserting the donation request to the database.
                               ...
                               if($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                $status="pending";
                                $action="none";
                                $sql="INSERT INTO blood_donation VALUES('$unit','$diseases','$usertype','$request_date','$donor_id','$donation_id','$admin_id','$status','$action')";//
                                ...
                                if($con->query($sql)==TRUE){    
                                    ...
                                    echo  "You will donate blood after three month";
                                }
